    ...
    return (
      <div>
        ...
        <p className="suggested">
          <a onClick={(e) => handleClick(e, QUALIA_URL)} href={QUALIA_URL}>
            How to secretly communicate with people on LSD - Qualia Computing
          </a>
        </p>
        <p className="suggested">
          <a onClick={(e) => handleClick(e, APPLE_URL)} href={APPLE_URL}>
            A letter from Apple to all customers - apple.com
          </a>
        </p>
        <p className="suggested">
          <a onClick={(e) => handleClick(e, IMGUR_URL)} href={IMGUR_URL}>
